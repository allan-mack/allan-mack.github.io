...
(function (global) {
  ...
  function printReport() {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>MerakiScope report — ${esc(d.org.name || '')}</title>
    ...
    // Open via a Blob URL with noopener: the report tab gets its own context and
    // cannot reach back into this app (window.opener) to read the in-memory key.
